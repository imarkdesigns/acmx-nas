...
<main id="main" class="main" role="main">
    ...
    <div class="about-track-record | uk-section uk-section-secondary uk-section-large uk-flex uk-flex-center uk-flex-middle uk-text-center">
        <div class="uk-container uk-container-small">
            ...
            <div class="track-record-wrapper counter | uk-grid-collapse uk-grid-match uk-text-center" uk-grid>
                ...
                <div class="uk-width-1-1 uk-width-1-3@s">
                    <div class="uk-tile uk-tile-orange uk-padding-small">
                        <span class="track-value">$<span><?php echo $hdr_track['tr_cash_distribution']; ?></span> <small>million</small></span>
                ...
                <div class="uk-width-1-1 uk-width-1-3@s">
                    <div class="uk-tile uk-tile-light-orange uk-padding-small">
                        <span class="track-value">$<span><?php echo $hdr_track['tr_portfolio_value']; ?></span> <small>billion</small></span>
                        <span class="track-caption">Managed Portfolio <br> Value</span>
                    </div>
                </div>
                <div class="uk-width-1-1 uk-width-1-3@s">
                    <div class="uk-tile uk-tile-dark-orange uk-padding-small">
                        <span class="track-value"><span><?php echo $hdr_track['tr_portfolio_sf']; ?></span> <small>million</small></span>
