...
?>
<header data-fragment="hero" class="property-hdr | uk-flex uk-flex-middle uk-light" data-src="<?php echo ( $pm_hdr_bg ) ? $pm_hdr_bg['url'] : 'https://placem.at/places?w=1920&h=550&txt=0&random=1' ?>" uk-img>
